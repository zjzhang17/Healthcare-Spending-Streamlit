...
def create_page2():
    ...
    if chart_type == 'Bar Chart':
        ...
        st.subheader("Healthcare Spending Overtime by State")
        ...
        st.subheader("The Average Spending on Healthcare Services Overtime")
...
pages = {
    ...
    "Inflation": create_page3,
    "Conclusion": create_page4
}
